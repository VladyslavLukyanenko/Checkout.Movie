...
namespace Checkout.Movie.Profiles.WebApi.Foundation
{
  public class IdentityServerStaticConfig
  {
    public static IEnumerable<IdentityResource> GetIdentityResources()
    {
      ...
      yield return new IdentityResource("profiles-api", "Profiles API", new[] {JwtClaimTypes.Id});
    }
    ...
    public static IEnumerable<Client> GetClients(IdentityConfig config)
    {
      ...
      yield return new Client
      {
        ...
        AllowedGrantTypes = {DiscordIdTokenGrantValidator.GrantTypeName},
        AllowedScopes =
        {
          "profiles-api"
        },
      ...
      yield return new Client
      {
        ...
        AccessTokenLifetime = (int) TimeSpan.FromSeconds(604800).TotalSeconds,
        AllowedGrantTypes = {DiscordRefreshTokenGrantValidator.GrantTypeName},
        AllowedScopes =
        {
          "profiles-api"
        },
